...
export const sendPasswordResetEmail = async (user, resetPasswordURL) => {
    console.log("user reseturl", user, resetPasswordURL);
  ...
  const mailOptions = {
    ...
    html: `
        ...
        <body>
            <div class="container">
                <div class="header">
                    <img class="logo" src="https://placehold.co/600x400/png" alt="Storefleet Logo">
                    <h1>Password Reset</h1>
                </div>
                <div class="content">
                    <p>Hello, ${user.name} 👤</p>
                    Enter this token to complete the reset : ${resetPasswordURL} 
                    use this token as parameter in  reset password route
